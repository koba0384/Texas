...
<style>
  * { box-sizing: border-box; }
  ...
  @media (max-width: 860px) {
    ...
    .nh-header { gap: 4px; margin-bottom: 4px; }
    .nh-title-wrap h1 { font-size: 16px; letter-spacing: 0.03em; }
    .nh-title-wrap p { display: none; }
    .nh-top-actions { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 4px; width: 100%; }
    .nh-btn { padding: 7px 8px; font-size: 11px; border-radius: 10px; }

    .nh-layout { grid-template-columns: 1fr; gap: 6px; }
    .nh-stage-panel { padding: 5px; border-radius: 14px; }
    .nh-stage-top { display: none; }
    ...
    .nh-table::before { inset: 8px; border-radius: 14px; }
    ...
    .nh-card { width: 28px; height: 40px; border-radius: 7px; }
    .nh-card.small { width: 18px; height: 26px; border-radius: 6px; }
    .nh-card-corner { font-size: 7px; left: 3px; top: 2px; }
    .nh-card-corner.bottom { right: 3px; bottom: 2px; }
    .nh-card-suit { font-size: 13px; }
    .nh-card-back-pattern { inset: 4px; border-radius: 6px; }
    ...
    .nh-pot-value { font-size: 16px; }
    .nh-winner-banner { width: 100%; padding: 6px 8px; font-size: 10px; border-radius: 10px; }
    .nh-center .nh-btn { width: 100%; padding: 6px 8px; font-size: 10px; border-radius: 10px; }
    ...
    .nh-seat.active { box-shadow: 0 0 0 1px rgba(92,255,225,0.12), 0 0 18px rgba(92,255,225,0.12); }
    ...
    .nh-cards { gap: 3px; margin-top: 4px; min-height: 26px; flex-wrap: nowrap; }
    .nh-best-hand { display: none; }
    .nh-action-badge { right: 4px; bottom: 4px; font-size: 8px; padding: 2px 5px; }

    .nh-seat.seat-2 { grid-column: 1; grid-row: 2; }
    .nh-seat.seat-1 { grid-column: 1; grid-row: 3; }
    .nh-seat.seat-3 { grid-column: 1; grid-row: 4; }
    ...
    .nh-seat.seat-0 .nh-role-badge { font-size: 9px; min-width: 24px; }
    .nh-seat.seat-0 .nh-stack-row {
      margin-top: 5px;
      font-size: 10px;
      flex-direction: row;
      flex-wrap: wrap;
    ...
    .nh-seat.seat-0 .nh-cards { gap: 8px; margin-top: 7px; min-height: 58px; }
    .nh-seat.seat-0 .nh-card.small { width: 42px; height: 60px; border-radius: 8px; }
    .nh-seat.seat-0 .nh-card-corner { font-size: 10px; left: 5px; top: 3px; }
    .nh-seat.seat-0 .nh-card-corner.bottom { right: 5px; bottom: 3px; }
    .nh-seat.seat-0 .nh-card-suit { font-size: 18px; }
    .nh-seat.seat-0 .nh-best-hand { display: block; margin-top: 6px; min-height: 14px; font-size: 10px; }
    ...
    .nh-phase-copy, .nh-action-summary { font-size: 10px; line-height: 1.35; }
    ...
    .nh-raise-presets .nh-preset { min-height: 36px; }
    .nh-preset { padding: 6px 4px; border-radius: 10px; font-size: 10px; line-height: 1.2; }
    ...
    .nh-side-panel-close { padding: 5px 7px; font-size: 10px; border-radius: 9px; }
    .nh-tabs { margin-bottom: 0; gap: 4px; }
    .nh-side-panel.open .nh-tabs { margin-bottom: 6px; }
    .nh-tab { padding: 6px 8px; font-size: 10px; border-radius: 10px; }
    .nh-side-content { max-height: calc(min(28vh, 200px) - 52px); padding-right: 1px; }
  ...
  @media (max-width: 430px) {
    .nh-title-wrap h1 { font-size: 15px; }
    .nh-table { min-height: 408px; grid-template-columns: 112px minmax(0, 1fr); gap: 5px; padding: 7px; }
    .nh-card { width: 26px; height: 38px; }
    .nh-card.small { width: 17px; height: 24px; }
    .nh-seat.seat-0 { padding: 7px; }
    .nh-seat.seat-0 .nh-card.small { width: 38px; height: 54px; }
    .nh-seat.seat-0 .nh-cards { gap: 7px; min-height: 54px; }
    .nh-action-grid .nh-btn,
    .nh-raise-presets .nh-preset { min-height: 34px; }
  }
</style>
""", unsafe_allow_html=True)
